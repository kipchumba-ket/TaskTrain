...
const Todo = ()=>{
    ...
    useEffect(() => {
        ...
        axios.post("http://localhost:3000/todos",{userid:localStorage.getItem('UserID')}).then((res)=>{
    ...
    const addTodo = (newTodo,newDesc)=>{
        ...
        axios.post("http://localhost:3000/todos",{todos :enteredTodos.items,userid:localStorage.getItem('UserID')}).then((res)=>{
